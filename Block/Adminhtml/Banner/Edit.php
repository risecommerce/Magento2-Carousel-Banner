 ...
 */
namespace Risecommerce\Banner\Block\Adminhtml\Banner;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Risecommerce_Banner::edit_banner')) {
        ...
        if (!$this->_isAllowedAction('Risecommerce_Banner::delete_banner')) {
